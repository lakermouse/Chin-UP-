...
namespace DarkTonic.CoreGameKit.EditorScripts
{
    ...
    public class WorldVariableInspector : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            if (DTInspectorUtility.IsPrefabInProjectView(stat.gameObject))
            {
...
#if MASTERAUDIO_ENABLED
        CGKMAHelper.SoundGroupField(_maInScene, _groupNames, "Variable Changed Sound", stat, ref isDirty, ref stat.variableChangedSound);
#endif
