...
namespace DarkTonic.CoreGameKit.EditorScripts
{
	...
	public class TimedDespawnerInspector : Editor
	{
		public override void OnInspectorGUI()
		{
			...
			var newStartTimer = EditorGUILayout.Toggle("Start Timer On Spawn", settings.StartTimerOnSpawn);
			if (newStartTimer != settings.StartTimerOnSpawn)
			{
				UndoHelper.RecordObjectPropertyForUndo(ref isDirty, settings, "toggle Start Timer On Spawn");
