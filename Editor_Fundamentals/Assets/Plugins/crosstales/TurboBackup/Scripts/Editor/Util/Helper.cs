...
*/
               ...
               {
                  EditorUtility.DisplayProgressBar("Backup", "Save UserSettings...", 0.75f);
         ...
         using (System.Diagnostics.Process process = new System.Diagnostics.Process())
         {
            try
            {
               ...
               if (Config.COPY_ASSETS)
               {
                  ...
                  sb.Append("Assets\" \"");
                  sb.Append(Constants.APPLICATION_PATH);
                  sb.Append("Assets\" /MIR /W:2 /R:3 /MT /NFL /NDL /NJH /NJS /nc /ns /np > NUL");
...
/*
               ...
               if (Config.COPY_LIBRARY)
               {
                  ...
                  sb.Append("Library\" \"");
                  sb.Append(Constants.APPLICATION_PATH);
                  sb.Append("Library\" /MIR /W:2 /R:3 /MT /NFL /NDL /NJH /NJS /nc /ns /np > NUL");
...
*/
               ...
               if (Config.COPY_SETTINGS)
               {
                  ...
                  sb.Append("ProjectSettings\" \"");
                  sb.Append(Constants.APPLICATION_PATH);
                  sb.Append("ProjectSettings\" /MIR /W:2 /R:3 /MT /NFL /NDL /NJH /NJS /nc /ns /np > NUL");
               ...
               if (Config.COPY_SETTINGS)
               {
                  EditorUtility.DisplayProgressBar("Restore", "Restore UserSettings...", 0.75f);
                  ...
                  sb.Append("UserSettings\" \"");
                  sb.Append(Constants.APPLICATION_PATH);
                  sb.AppendLine("UserSettings\" /MIR /W:2 /R:3 /MT /NFL /NDL /NJH /NJS /nc /ns /np > NUL");
               ...
               if (Config.COPY_PACKAGES)
               {
                  ...
                  sb.Append("Packages\" \"");
                  sb.Append(Constants.APPLICATION_PATH);
                  sb.Append("Packages\" /MIR /W:2 /R:3 /MT /NFL /NDL /NJH /NJS /nc /ns /np > NUL");
