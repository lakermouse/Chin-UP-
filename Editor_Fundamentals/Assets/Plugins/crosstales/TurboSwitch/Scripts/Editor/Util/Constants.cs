...
namespace Crosstales.TPS.Util
{
   ...
   public abstract class Constants : Crosstales.Common.Util.BaseConstants
   {
      ...
      public const string ASSET_API_URL = "https://www.crosstales.com/en/assets/tps/api/";

      /// <summary>URL of the asset forum.</summary>
      public const string ASSET_FORUM_URL = "https://forum.unity.com/threads/turbo-switch-fast-and-save-platform-switches.434860/";
      ...
      public static readonly string DEFAULT_PATH_CACHE = Crosstales.Common.Util.FileHelper.ValidatePath(APPLICATION_PATH + CACHE_DIRNAME);
...
#else
      public const bool DEFAULT_USE_LEGACY = true;
#endif
      ...
      */
      ...
      public static string ASSET_ID => "60040";

      /// <summary>Returns the UID of the asset.</summary>
      /// <returns>The UID of the asset.</returns>
      public static System.Guid ASSET_UID => new System.Guid("2d03d693-219a-4fa4-a9b0-83e5a59ebe01");
