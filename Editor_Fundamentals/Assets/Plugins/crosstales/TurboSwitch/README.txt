...
We measured speed improvements up to 100x faster than the built-in switch in Unity (with AssetDatabase V1).
...
Follow these steps to upgrade the version of "TPS PRO":
...
* [Forum](https://forum.unity.com/threads/turbo-switch-fast-and-save-platform-switches.434860/)
* [Documentation](https://www.crosstales.com/media/data/assets/tps/TurboSwitch-doc.pdf)
* [API](https://www.crosstales.com/en/assets/tps/api/)
