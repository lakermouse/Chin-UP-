...
namespace DarkTonic.CoreGameKit
{
    ...
    public class TriggeredSpawnerV2 : MonoBehaviour, ICgkEventReceiver {
        ...
        public bool spawnSettingsExpanded = false;
        public bool spawnOutsidePool = false;
        public bool spawnsFollowThis = false;
        public SpawnerGoneBehavior spawnerGoneBehavior = SpawnerGoneBehavior.DoNothing;
        public bool spawnerGoneStopChildParticles;
        ...
        public bool masterAudioSoundsExpanded = true;
        public string itemfailedToSpawnSound = MasterAudio.MasterAudio.NoGroupName;
        public string itemSpawnedSound = MasterAudio.MasterAudio.NoGroupName;
        public string waveFinishedSpawningSound = MasterAudio.MasterAudio.NoGroupName;
        public string waveStartSound = MasterAudio.MasterAudio.NoGroupName;
        public string eliminationWaveCompletedSound = MasterAudio.MasterAudio.NoGroupName;
        public string waveRepeatSound = MasterAudio.MasterAudio.NoGroupName;
        public string spawnerDespawningSound = MasterAudio.MasterAudio.NoGroupName;
        public string spawningSound = MasterAudio.MasterAudio.NoGroupName;
        public string despawnedSound = MasterAudio.MasterAudio.NoGroupName;
#endif
        ...
        public enum SpawnerGoneBehavior {
            DoNothing,
            StopAllParticles
        }
...
#if MASTERAUDIO_ENABLED
                CGKMARuntimeHelper.PlaySoundFollowTransform(waveStartSound, Trans);
#endif
                if (listener != null) {
...
#if MASTERAUDIO_ENABLED
            CGKMARuntimeHelper.PlaySoundFollowTransform(itemSpawnedSound, Trans);
#endif
            if (listener != null) {
...
#if MASTERAUDIO_ENABLED
            CGKMARuntimeHelper.PlaySoundFollowTransform(despawnedSound, Trans);
#endif
            if (listener != null) {
...
#region public methods
        ...
        /// <param name="wave">Metadata of the Wave</param>
        ...
        protected virtual Transform SpawnWaveItem(Transform prefabToSpawn, Vector3 spawnPosition, Quaternion rotation, TriggeredWaveMetaData wave) {
            ...
            if (spawned != null) {
                ...
                if (spawnsFollowThis) {
                    var follower = spawned.GetComponent<SpawnerTransformFollower>();
                    if (follower == null) {
                        follower = spawned.gameObject.AddComponent<SpawnerTransformFollower>();
                    }
                    ...
                    follower.StartFollowing(Trans, spawnerGoneBehavior, spawnerGoneStopChildParticles);
                }
            }
        ...
        protected virtual Transform GetSpawnable(TriggeredWaveMetaData wave) {
            switch (wave.waveSpec.spawnFrom)
            {
                ...
                case PoolBoss.PrefabSource.Addressable:
                    var go = PoolAddressableOptimizer.RetrieveStoredHandle(wave.waveSpec.prefabToSpawnAddressable);
                    if (go == null)
                    {
                        return null;
                    }
        ...
        protected virtual bool CanSpawnOne(TriggeredWaveMetaData wave) {
            if (!wave.waveSpec.enableLimits) {
                return true;
            }

            if (wave.waveSpec.limitUseSpawnCap) {
                if (wave.spawnedWaveMembers.Count >= wave.waveSpec.doNotSpawnIfSpawnCapReached.Value) {
                    return false;
                }
            }

            if (wave.waveSpec.limitUseMinDistance) {
                var allSpawnedAreFarEnoughAway = SpawnUtility.SpawnedMembersAreAllBeyondDistance(_trans, wave.spawnedWaveMembers,
                    wave.waveSpec.doNotSpawnIfMbrCloserThan.Value + wave.currentRandomLimitDistance);

                if (!allSpawnedAreFarEnoughAway) {
                    return false;
                }
            }
...
#endif
                if (listener != null) {
                    listener.WaveStart(TriggeredSpawner.EventType.CustomEvent, userDefWave);
                }
            }
        }
...
#region Helper methods
...
#if MASTERAUDIO_ENABLED
            CGKMARuntimeHelper.PlaySoundFollowTransform(eliminationWaveCompletedSound, Trans);
#endif
...
#if MASTERAUDIO_ENABLED
                CGKMARuntimeHelper.PlaySoundFollowTransform(waveRepeatSound, Trans);
#endif
                if (listener != null) {
...
#if MASTERAUDIO_ENABLED
                            CGKMARuntimeHelper.PlaySoundFollowTransform(itemfailedToSpawnSound, Trans);
#endif
...
#if MASTERAUDIO_ENABLED
                    CGKMARuntimeHelper.PlaySoundFollowTransform(waveFinishedSpawningSound, Trans);
#endif
...
#if MASTERAUDIO_ENABLED
            CGKMARuntimeHelper.PlaySoundFollowTransform(spawnerDespawningSound, Trans);
#endif
            if (listener != null) {
        ...
        private bool SetupNextWave(TriggeredWaveSpecifics newWave, TriggeredSpawner.EventType eventType, int repetitionNumber = 0, int repetitionNumberWithReset = 0) {
            ...
            if (newWave.enableLimits && newWave.limitUseMinDistance) {
                newMetaWave.currentRandomLimitDistance = Random.Range(-newWave.doNotSpawnRandomDist.Value,
                    newWave.doNotSpawnRandomDist.Value);
            }
        ...
        private void CheckForValidVariablesForWave(TriggeredWaveSpecifics wave, TriggeredSpawner.EventType eType) {
            ...
            if (wave.enableLimits) {
                if (wave.limitUseMinDistance) {
                    wave.doNotSpawnIfMbrCloserThan.LogIfInvalid(_trans, "Spawn Limit Min. Distance", null,
                        null, eType.ToString());
                    wave.doNotSpawnRandomDist.LogIfInvalid(_trans, "Spawn Limit Random Distance", null,
                        null, eType.ToString());
                }
                if (wave.limitUseSpawnCap) {
                    wave.doNotSpawnIfSpawnCapReached.LogIfInvalid(_trans, "Spawn Cap", null, null, eType.ToString());
                }
            }
            ...
            if (wave.enableRepeatWave) {
                ...
                wave.maxRepeat.LogIfInvalid(Trans, "Wave Repetitions", null, null, eType.ToString());
                wave.repeatItemInc.LogIfInvalid(Trans, "Repeat Spawn Increase", null, null, eType.ToString());
                wave.repeatItemMinLmt.LogIfInvalid(Trans, "Repeat Spawn Min Limit", null, null, eType.ToString());
                wave.repeatItemLmt.LogIfInvalid(Trans, "Repeat Spawn Max Limit", null, null, eType.ToString());
                wave.repeatTimeInc.LogIfInvalid(Trans, "Repeat Time Increase", null, null, eType.ToString());
                wave.repeatTimeMinLmt.LogIfInvalid(Trans, "Repeat Time Min Limit", null, null, eType.ToString());
                wave.repeatTimeLmt.LogIfInvalid(Trans, "Repeat Time Max Limit", null, null, eType.ToString());
            }
            ...
            if (wave.retriggerLimitMode == TriggeredSpawner.RetriggerLimitMode.TimeBased) {
        ...
        private void SpawnBonusPrefabIfAny(TriggeredWaveSpecifics currentWave, Vector3 spawnPosition) {
            ...
            switch (waveBeat.bonusPrefabFrom)
            {
                case PoolBoss.PrefabSource.Prefab:
...
#if ADDRESSABLES_ENABLED
                case PoolBoss.PrefabSource.Addressable:
                    var bonusPrefabGO = PoolAddressableOptimizer.RetrieveStoredHandle(waveBeat.bonusPrefabAddressable);
                    if (bonusPrefabGO == null)
                    {
                        LevelSettings.LogIfNew("Bonus Prefab for Level: " + LevelSettings.CurrentDisplayLevel + ", Wave: " + LevelSettings.CurrentDisplayWave + " is unassigned.");
                        return;
                    }

                    var numberToSpawn2 = waveBeat.bonusPrefabQty.Value;
                    for (var i = 0; i < numberToSpawn2; i++)
                    {
                        var spawned = PoolBoss.SpawnInPool(bonusPrefabGO.transform, spawnPosition, Quaternion.identity);
                        if (spawned == null)
                        {
                            break;
                        }
...
#region Properties
        ...
        public bool SpawnerIsPaused {
            get { return LevelSettings.Instance.useWaves && LevelSettings.WavesArePaused && wavePauseBehavior == TriggeredSpawner.WavePauseBehavior.Disable; }
        }
