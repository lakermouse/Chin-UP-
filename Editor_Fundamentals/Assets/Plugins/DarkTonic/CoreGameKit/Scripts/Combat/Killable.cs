...
namespace DarkTonic.CoreGameKit {
	...
	public class Killable : MonoBehaviour {
		/*! \cond PRIVATE */
		public const string DestroyedText = "Killed";
		...
		public string poolBossItemName;
		public bool shouldSelectFromPB = false;

		public bool invincibilityExpanded = false;
		public bool isInvincible;
#if MASTERAUDIO_ENABLED
		public string invincibleHitSound = MasterAudio.MasterAudio.NoGroupName;
#endif
		...
		public PoolBoss.PrefabSource invinceHitPrefabFrom = PoolBoss.PrefabSource.Prefab;
...
#if ADDRESSABLES_ENABLED
		public AssetReference invinceHitPrefabAddressable;
#endif
		public string invinceHitPrefabCategoryName;
		public string invinceHitPrefabPoolItemName;
		public bool shouldInvinceHitPrefabSelectFromPB = false;
...
#if MASTERAUDIO_ENABLED
		public string vanishSound = MasterAudio.MasterAudio.NoGroupName;
#endif
		public SpawnSource vanishPrefabSource = SpawnSource.None;
		public PoolBoss.PrefabSource vanishPrefabFrom = PoolBoss.PrefabSource.Prefab;
		public int vanishPrefabPoolIndex = 0;
		public string vanishPrefabPoolName = null;
		public Transform vanishPrefabSpecific;
#if ADDRESSABLES_ENABLED
		public AssetReference vanishPrefabAddressable;
#endif
		public string vanishPrefabCategoryName;
		public string vanishPrefabPoolItemName;
		public bool shouldVanishPrefabSelectFromPB = false;
...
#if MASTERAUDIO_ENABLED
		public string dealDamageSound = MasterAudio.MasterAudio.NoGroupName;
#endif
        ...
        public DealDamageMode dealDamageMode = DealDamageMode.AttackPoints;
        public DeathVelocityDamageCalcMode dealDamageCalcMode = DeathVelocityDamageCalcMode.Fixed;
        public KillerFloat dealDamageFixed = new KillerFloat(0.1f, .1f, float.MaxValue);
        public SpawnSource dealDamagePrefabSource = SpawnSource.None;
		public PoolBoss.PrefabSource dealDamagePrefabFrom = PoolBoss.PrefabSource.Prefab;
...
#if ADDRESSABLES_ENABLED
		public AssetReference dealDamagePrefabAddressable;
#endif
		public string dealDamagePrefabCategoryName;
		public string dealDamagePrefabPoolItemName;
		public bool shouldDealDamagePrefabSelectFromPB = false;
		...
		public PoolBoss.PrefabSource damagePrefabFrom = PoolBoss.PrefabSource.Prefab;
		public int damagePrefabPoolIndex = 0;
		public string damagePrefabPoolName = null;
		public Transform damagePrefabSpecific;
#if ADDRESSABLES_ENABLED
		public AssetReference damagePrefabAddressable;
#endif
		public string damagePrefabCategoryName;
		public string damagePrefabPoolItemName;
		public bool shouldDamagePrefabSelectFromPB = false;
#if MASTERAUDIO_ENABLED
		public string damagedSound = MasterAudio.MasterAudio.NoGroupName;
#endif
...
#if MASTERAUDIO_ENABLED
		public string knockbackSound = MasterAudio.MasterAudio.NoGroupName;
#endif
...
#if MASTERAUDIO_ENABLED
		public string deathSound = MasterAudio.MasterAudio.NoGroupName;
#endif
		...
		public bool deathPrefabExpanded = true;
		...
		public bool shouldDeathPrefabSelectFromPB = false;
        ...
        public bool useDeathVelocity = false;
        public KillerFloat deathVelocity = new KillerFloat(1f, 0.1f, float.MaxValue);
        public DeathVelocityCheckEvent deathVelocityCheckEvent = DeathVelocityCheckEvent.Continuous;
        public TriggeredSpawner.RetriggerLimitMode deathVelocityRetriggerLimitMode = TriggeredSpawner.RetriggerLimitMode.None;
        public KillerInt deathVelLimitPerXFrm = new KillerInt(1, 1, int.MaxValue);
        public KillerFloat deathVelLimitPerXSec = new KillerFloat(0.1f, .1f, float.MaxValue);
        public DeathVelocityMode deathVelocityMode = DeathVelocityMode.Die;
        public DeathVelocityDamageCalcMode deathVelocityDamageCalcMode = DeathVelocityDamageCalcMode.Fixed;
        public KillerFloat deathVelDamageFixed = new KillerFloat(0.1f, .1f, float.MaxValue);
        private int deathVelTrigLastFrame = -10;
        private float deathVelTrigLastTime = -10f;
...
#if MASTERAUDIO_ENABLED
		public string respawnSound = MasterAudio.MasterAudio.NoGroupName;
#endif
        ...
        private List<KillableDeathPrefab> _additionalDeathPrefabs = new List<KillableDeathPrefab>();
...
#region enums
        ...
        public enum DeathVelocityCheckEvent {
            Collision,
            Continuous
        }

        public enum DeathVelocityMode {
            Damage,
            Die
        }

        public enum DeathVelocityDamageCalcMode {
            Fixed,
            FixedTimesMass,
            FixedTimesVelocity,
            FixedTimesVelocityTimesMass
        }
...
#region MonoBehavior events and associated virtuals
		...
		private void Awake() {
			_timesRespawned = 0;
            _additionalDeathPrefabs.Clear();
			_additionalDeathPrefabs.AddRange(GetComponents<KillableDeathPrefab>());
			ResetSpawnerInfo();
		}
		...
		public virtual void ControllerColliderHit(GameObject hit, bool calledFromOtherKillable = false) {
			if (calledFromOtherKillable && IsCharController) {
		...
		protected virtual void LateUpdate() {
            ...
            // check for Death Velocity
            if (useDeathVelocity && deathVelocityCheckEvent == DeathVelocityCheckEvent.Continuous) {
                switch (deathVelocityRetriggerLimitMode) {
                    case TriggeredSpawner.RetriggerLimitMode.FrameBased:
                        if (Time.frameCount - deathVelTrigLastFrame < deathVelLimitPerXFrm.Value) {
                            if (LevelSettings.IsLoggingOn) {
                                Debug.LogError(
                                    string.Format("Death Velocity of transform: '{0}' was limited by retrigger frame count setting.", Trans.name));
                            }
                            goto AfterDeathVelocityCheck;
                        }
                        break;
                    case TriggeredSpawner.RetriggerLimitMode.TimeBased:
                        if (Time.timeSinceLevelLoad - deathVelTrigLastTime < deathVelLimitPerXSec.Value) {
                            if (LevelSettings.IsLoggingOn) {
                                Debug.LogError(
                                    string.Format("Death Velocity of transform: '{0}' was limited by retrigger time setting.", Trans.name));
                            }
                            goto AfterDeathVelocityCheck;
                        }
                        break;
                ...
                CheckForDeathVelocity();

                if (deathVelocityCheckEvent == DeathVelocityCheckEvent.Continuous) {
                    switch (deathVelocityRetriggerLimitMode) {
                        case TriggeredSpawner.RetriggerLimitMode.FrameBased:
                            deathVelTrigLastFrame = Time.frameCount;
                            break;
                        case TriggeredSpawner.RetriggerLimitMode.TimeBased:
                            deathVelTrigLastTime = Time.timeSinceLevelLoad;
                            break;
                    }
                }
            }

            AfterDeathVelocityCheck:
...
#region Helper Methods
        ...
        private void CheckForDeathVelocity() {
            if (!useDeathVelocity) {
                return;
            }
            ...
            var velocity = WorkingVelocity;

            if (velocity <= deathVelocity.Value) {
                return; // not fast enough. No effect
            }

            switch (deathVelocityMode) {
                case DeathVelocityMode.Die:
                    DestroyKillable();
                    break;
                case DeathVelocityMode.Damage:
                    var dmgPoints = deathVelDamageFixed.Value;

                    switch (deathVelocityDamageCalcMode) {
                        case DeathVelocityDamageCalcMode.Fixed:
                            break;
                        case DeathVelocityDamageCalcMode.FixedTimesMass:
                            dmgPoints *= WorkingMass;
                            break;
                        case DeathVelocityDamageCalcMode.FixedTimesVelocity:
                            dmgPoints *= velocity;
                            break;
                        case DeathVelocityDamageCalcMode.FixedTimesVelocityTimesMass:
                            dmgPoints *= WorkingMass * velocity;
                            break;
                    }

                    TakeDamage((int)dmgPoints);
        ...
        private void CheckForValidVariables() {
            ...
            if (distanceDeathEnabled) {
                tooFarDistance.LogIfInvalid(Trans, "Killable Death Distance");
            }

            if (useDeathVelocity) {
                deathVelocity.LogIfInvalid(Trans, "Killable Death Velocity");
                if (deathVelocityRetriggerLimitMode == TriggeredSpawner.RetriggerLimitMode.FrameBased) {
                    deathVelLimitPerXFrm.LogIfInvalid(Trans, "Death Velocity Min Frames Between");
                }
                if (deathVelocityRetriggerLimitMode == TriggeredSpawner.RetriggerLimitMode.TimeBased) {
                    deathVelLimitPerXSec.LogIfInvalid(Trans, "Death Velocity Min Seconds Between");
                }
                if (deathVelocityMode == DeathVelocityMode.Damage) {
                    deathVelDamageFixed.LogIfInvalid(Trans, "Death Velocity Fixed Damage");
                }
            }

            if (dealDamageMode == DealDamageMode.Calculation) {
                dealDamageFixed.LogIfInvalid(Trans, "Deal Damage Fixed Damage");
            }
		...
		private void CheckForAttackPoints(Killable enemy, GameObject goHit) {
			...
			if (enemy == null) {
                ...
                switch (enemy.dealDamageMode) {
                    case DealDamageMode.AttackPoints:
                        attackPoints = enemy.atckPoints.Value;
                        break;
                    case DealDamageMode.Calculation:
                        var tempAtk = dealDamageFixed.Value;

                        switch (enemy.dealDamageCalcMode) {
                            case DeathVelocityDamageCalcMode.Fixed:
                                // already assigned
                                break;
                            case DeathVelocityDamageCalcMode.FixedTimesMass:
                                attackPoints = (int)(tempAtk * WorkingMass);
                                break;
                            case DeathVelocityDamageCalcMode.FixedTimesVelocity:
                                attackPoints = (int)(tempAtk * WorkingVelocity);
                                break;
                            case DeathVelocityDamageCalcMode.FixedTimesVelocityTimesMass:
                                attackPoints = (int)(tempAtk * WorkingMass * WorkingVelocity);
                                break;
                        }
                        break;
                }
...
#if MASTERAUDIO_ENABLED
			CGKMARuntimeHelper.PlaySoundFollowTransform(deathSound, Trans);
#endif
		...
		private void SpawnDamagePrefabs(int damagePoints) {
...
#if MASTERAUDIO_ENABLED
			CGKMARuntimeHelper.PlaySoundFollowTransform(damagedSound, Trans);
#endif
			...
			for (var i = 0; i < numberToSpawn; i++) {
				...
				if (damagePrefabSource == SpawnSource.None || damagePrefabSource != SpawnSource.None) {
...
#if MASTERAUDIO_ENABLED
			CGKMARuntimeHelper.PlaySoundFollowTransform(enemy.dealDamageSound, enemy.Trans);
#endif
		...
		private void SpawnDeathPrefabs() {
            if (UnityEngine.Random.Range(0, 100) < deathPrefabSpawnPercent.Value) {
				...
				for (var i = 0; i < deathPrefabQty.Value; i++) {
					...
					spawnPos += (deathPrefabIncrementalOffset * i);

					spawnPos.x += UnityEngine.Random.Range(-deathPrefabRandomDistX.Value, deathPrefabRandomDistX.Value);
					spawnPos.y += UnityEngine.Random.Range(-deathPrefabRandomDistY.Value, deathPrefabRandomDistY.Value);
					spawnPos.z += UnityEngine.Random.Range(-deathPrefabRandomDistZ.Value, deathPrefabRandomDistZ.Value);
					...
					if (spawnedDeathPrefab != null) {
						...
						var deathPreHasRigidBody = false;
						var deathPreIsGravity = false;
						var bodyIsGravity = false;

#if PHY3D_ENABLED
						var spawnedBody = spawnedDeathPrefab.GetComponent<Rigidbody>();
						if (spawnedBody != null)
						{
							deathPreHasRigidBody = true;
							deathPreIsGravity = !spawnedBody.isKinematic;
						}

						if (IsBody)
						{
							bodyIsGravity = !Body.isKinematic;
						}
#endif

						if (deathPreHasRigidBody && deathPreIsGravity && IsBody && bodyIsGravity) {
#if PHY3D_ENABLED
			...
			for (var d = 0; d < _additionalDeathPrefabs.Count; d++) {
				var aDeathPrefab = _additionalDeathPrefabs[d];

				if (UnityEngine.Random.Range(0, 100) >= aDeathPrefab.deathPrefabSpawnPercent.Value) {
					continue;
				}

                var spawnPos = GetDeathPrefabSpawnPosition(aDeathPrefab);
                spawnPos += aDeathPrefab.deathPrefabOffset;

                for (var i = 0; i < aDeathPrefab.deathPrefabQty.Value; i++) {
                    var deathPre = GetCurrentDeathPrefab(aDeathPrefab);

                    switch (aDeathPrefab.deathPrefabSource) {
                        case WaveSpecifics.SpawnOrigin.Specific:
                            if (aDeathPrefab.deathPrefabSpecific == null) {
                                continue; // nothing to spawn
                            }
                            break;
                    ...
                    spawnPos += (aDeathPrefab.deathPrefabIncrementalOffset * i);

					spawnPos.x += UnityEngine.Random.Range(-aDeathPrefab.deathPrefabRandomDistX.Value, aDeathPrefab.deathPrefabRandomDistX.Value);
					spawnPos.y += UnityEngine.Random.Range(-aDeathPrefab.deathPrefabRandomDistY.Value, aDeathPrefab.deathPrefabRandomDistY.Value);
					spawnPos.z += UnityEngine.Random.Range(-aDeathPrefab.deathPrefabRandomDistZ.Value, aDeathPrefab.deathPrefabRandomDistZ.Value);

					var spawnRotation = deathPre.transform.rotation;
                    switch (aDeathPrefab.rotationMode) {
                        case RotationMode.InheritExistingRotation:
                            spawnRotation = Trans.rotation;
                            break;
                        case RotationMode.CustomRotation:
                            spawnRotation = Quaternion.Euler(aDeathPrefab.deathPrefabCustomRotation);
                            break;
                    }

                    var euler = spawnRotation.eulerAngles;

                    if (aDeathPrefab.deathPrefabRandomizeXRotation) {
                        euler.x = UnityEngine.Random.Range(0f, 360f);
                    }
                    if (aDeathPrefab.deathPrefabRandomizeYRotation) {
                        euler.y = UnityEngine.Random.Range(0f, 360f);
                    }
                    if (aDeathPrefab.deathPrefabRandomizeZRotation) {
                        euler.z = UnityEngine.Random.Range(0f, 360f);
                    }

                    spawnRotation = Quaternion.Euler(euler);

                    var theParent = aDeathPrefab.deathPrefabKeepSameParent ? Trans.parent : null;
                    var spawnedDeathPrefab = SpawnDeathPrefab(deathPre, spawnPos, spawnRotation, theParent);
                    ...
                    if (spawnedDeathPrefab != null) {
                        ...
                        if (!aDeathPrefab.deathPrefabKeepVelocity) {
                            continue;
                        }

						var deathPreHasBody = false;
						var deathPreIsGravity = false;
						var bodyIsGravity = false;
#if PHY3D_ENABLED
						var spawnedBody = spawnedDeathPrefab.GetComponent<Rigidbody>();
						...
						if (deathPreHasBody && deathPreIsGravity && IsBody && bodyIsGravity) {
#if PHY3D_ENABLED
                            spawnedBody.velocity = Body.velocity;
#endif
                        } else {
...
#if MASTERAUDIO_ENABLED
			CGKMARuntimeHelper.PlaySoundFollowTransform(vanishSound, Trans);
#endif
...
#region Pooling methods
...
#if MASTERAUDIO_ENABLED
					CGKMARuntimeHelper.PlaySoundFollowTransform(respawnSound, Trans);
#endif
        ...
        public virtual void Knockback(Killable enemy) {
...
#if MASTERAUDIO_ENABLED
			CGKMARuntimeHelper.PlaySoundFollowTransform(knockbackSound, Trans);
#endif
			...
			if (pushForce > 0 || pushHeight > 0) {  
				// do nothing, eliminate warming 
			}
		...
		protected virtual void SpawnedOrAwake(bool spawned = true) {
			...
			{
				switch (damagePrefabFrom)
                {
					case PoolBoss.PrefabSource.Prefab:
						if (damagePrefabSpecific == null)
                        {
					...
					case PoolBoss.PrefabSource.Addressable:
						if (!PoolAddressableOptimizer.IsAddressableValid(damagePrefabAddressable))
                        {
							LevelSettings.LogIfNew(string.Format("Damage Prefab for '{0}' is not assigned.", Trans.name));
						}
						break;
		...
		public virtual void TakeDamage(int damagePoints, Killable enemy) {
			...
			if (IsInvincible()) {
#if MASTERAUDIO_ENABLED
				CGKMARuntimeHelper.PlaySoundFollowTransform(invincibleHitSound, Trans);
#endif
...
#region Properties
        ...
        /*! \cond PRIVATE */
        private Transform GetCurrentDeathPrefab(KillableDeathPrefab deathPrefab) {
            switch (deathPrefabFrom)
            {
				case PoolBoss.PrefabSource.Prefab:
					switch (deathPrefab.deathPrefabSource)
					{
						case WaveSpecifics.SpawnOrigin.Specific:
							return deathPrefab.deathPrefabSpecific;
						case WaveSpecifics.SpawnOrigin.PrefabPool:
							return deathPrefab.DeathPrefabWavePool.GetRandomWeightedTransform();
					}
					break;
#if ADDRESSABLES_ENABLED
				case PoolBoss.PrefabSource.Addressable:
					var go = PoolAddressableOptimizer.RetrieveStoredHandle(deathPrefab.deathPrefabAddressable);
					if (go == null)
					{
						return null;
					}
...
#if ADDRESSABLES_ENABLED
					case PoolBoss.PrefabSource.Addressable:
						var go = PoolAddressableOptimizer.RetrieveStoredHandle(deathPrefabAddressable);
						if (go == null)
                        {
							return null;
                        }
...
#if ADDRESSABLES_ENABLED
					case PoolBoss.PrefabSource.Addressable:
						var go = PoolAddressableOptimizer.RetrieveStoredHandle(damagePrefabAddressable);
						if (go == null)
						{
							return null;
						}
...
#if ADDRESSABLES_ENABLED
					case PoolBoss.PrefabSource.Addressable:
						var go = PoolAddressableOptimizer.RetrieveStoredHandle(dealDamagePrefabAddressable);
						if (go == null)
						{
							return null;
						}
		...
		public bool IsGravBody {
			get {
#if PHY3D_ENABLED
				return Body != null && Body.useGravity;
#else
	#if PHY2D_ENABLED
				return Body2D != null && Body2D.gravityScale > 0;
	#endif
#endif
...
#endif
#if PHY2D_ENABLED
				if (Body2D != null && Body2D.gravityScale != 0) {
                    return Body2D.velocity.x + Body2D.velocity.y;
                }
#endif
                return 1f; // used in multiplication, so the 1 won't affect it if no Rigidbody
            }
        }
        ...
        private Vector3 GetDeathPrefabSpawnPosition(KillableDeathPrefab deathPrefab) {
            switch (deathPrefab.deathPrefabSpawnLocation) {
