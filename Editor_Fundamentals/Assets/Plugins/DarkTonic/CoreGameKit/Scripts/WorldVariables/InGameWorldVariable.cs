    ...
    public class InGameWorldVariable {
            ...
            get {
                ...
                switch (_varType)
                {
                    case WorldVariableTracker.VariableType._float:
                        return _sourceStat.floatMaxValue;
                    case WorldVariableTracker.VariableType._integer:
                        return _sourceStat.intMaxValue;
                    default:
                        return null;
                }
            }
        ...
        public float? EndGameMinValue {
            get {
                ...
                {
                    case WorldVariableTracker.VariableType._float:
                        return _sourceStat.endGameMinValueFloat;
                    case WorldVariableTracker.VariableType._integer:
                        return _sourceStat.endGameMinValue;
                    default:
                        return null;
                }
            }
        ...
        public float? EndGameMaxValue {
            get {
                ...
                {
                    case WorldVariableTracker.VariableType._float:
                        return _sourceStat.endGameMaxValueFloat;
                    case WorldVariableTracker.VariableType._integer:
                        return _sourceStat.endGameMaxValue;
                    default:
                        return null;
                }
            }
